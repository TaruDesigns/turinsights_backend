...
uipclient_queueuitems = uipath_orchestrator_rest.QueueItemsApi(
    ApiClient(uipclient_config)
)
uipclient_queueuitemevents = uipath_orchestrator_rest.QueueItemEventsApi(
    ApiClient(uipclient_config)
)
uipclient_queuedefinitions = uipath_orchestrator_rest.QueueDefinitionsApi(
    ApiClient(uipclient_config)
)
