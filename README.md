...
This project depends on [services](https://github.com/TaruDesigns/turinsights_services) as part of the full stack.
This repo ONLY includes the backend+celeryworker code
...
* Additional to the contents it might have, add a new line with the custom IP (e.g. `192.168.99.150`) a space character, and your fake local domain: `dev.uipathmanager.com`.
